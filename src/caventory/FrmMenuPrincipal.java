...
public class FrmMenuPrincipal extends javax.swing.JFrame {
    ...
    public FrmMenuPrincipal() {
        ...
        if (CaVentory.rolActual.equals("Administrador")) {
            ...
            btnColaboradores.setEnabled(true);
            lblPermisos.setText("Puedes administrar productos, categorias, movimientos y colaboradores.");
        } else {
            btnCategorias.setEnabled(false);
            btnColaboradores.setEnabled(false);
            lblPermisos.setText("Puedes consultar productos y registrar entradas o salidas.");
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("CaVentory - Menu principal");
        setResizable(false);
